...
Listens on https port `7143` and will exchange grpc message in probuf format through the `echo-messages` topic in Kafka.
...
+ kubectl port-forward --namespace zilla-grpc-kafka-echo service/zilla-grpc-kafka-echo 7143
+ nc -z localhost 7143
